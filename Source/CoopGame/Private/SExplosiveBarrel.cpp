...
ASExplosiveBarrel::ASExplosiveBarrel()
{
	...
	//Set to physicsbody to let radial component affect us(eg. when a nearby barrel explosion)
	...
	RadialForceComp->bAutoActivate = false;//Prevent component from ticking, only use FireImpulse() instead
